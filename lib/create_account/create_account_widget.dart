                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'ed6rycgm' /* Email Address */,
                                  ),
                                  labelStyle:
                                      FlutterFlowTheme.of(context).bodyText1,
                                  hintText: FFLocalizations.of(context).getText(
                                    'cwb105jz' /* Enter your email here... */,
                                  ),
                                  hintStyle:
                                      FlutterFlowTheme.of(context).bodyText1,
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelStyle:
                                      FlutterFlowTheme.of(context).bodyText1,
                                  hintText: FFLocalizations.of(context).getText(
                                    'c8impjd7' /* Enter your password here... */,
                                  ),
                                  hintStyle:
                                      FlutterFlowTheme.of(context).bodyText1,
                                  enabledBorder: OutlineInputBorder(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '7e59q9ha' /* Already have an account? */,
                                ),
